{
  ...
  # Pull pre-built artifacts from the Logos binary cache when available.
  nixConfig = {
  ...
  inputs = {
    logos-module-builder.url = "github:3esmit/logos-module-builder?rev=5333be8b5b5d0349e9fd182a134f23cc6e1297b2";
    logos-blockchain.url = "github:3esmit/logos-blockchain?rev=a49c4cb4d20a58bd1d5e9817bcab31a854278cdb";
  };
        ...
        in {
          testnet-package-profile = pkgs.runCommand
            "blockchain-module-testnet-package-profile" {
              ...
              ${pkgs.gnugrep}/bin/grep -Fq -- 'chain_sync_protocol_name: /logos-blockchain-testnet-0.2.4/chainsync/1.0.0' "$TMPDIR/protocols"
